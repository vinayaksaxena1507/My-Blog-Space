    ...
    post && (
      <article className="px-10 pb-28">
        <section className="space-y-2 border border-emphasize">
          <div className="min-h-56 relative flex flex-col justify-between md:flex-row mx-auto w-full h-56 object-cover hover:h-[300px] md:hover:h-[300px] lg:hover:h-[400px]    transition-all duration-500 ease-in-out">
